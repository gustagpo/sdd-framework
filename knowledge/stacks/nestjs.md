...
**Origem**: algar/LESSONS.md L080 (padrão evoluído) — rodada renomeacao-plano-para-assinatura (28/07/2026); `renomeacao-plano-para-assinatura.migration.spec.ts`. Reforço: rodada serasa-relatorios-basicos (04/08/2026), conflito C-4 do CONTRACT + L077 do projeto.
