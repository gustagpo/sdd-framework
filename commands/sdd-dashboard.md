...
1. Leia `specs/sdd.config.json` (se ausente, informe que o projeto não usa o SDD Framework e sugira `/sdd-init`).
2. **Atualize a telemetria** (best-effort) das features com RUN.jsonl antes de reportar:
   ```bash
